/** HighlightSvc: הדגשות ייעודיות לגיליון "חריגים-כללי" */
var HighlightSvc = (() => {

  /**
   * צובע בצהוב את כל התאים הלא-ריקים בעמודה "הודעת מערכת" בגיליון "חריגים-כללי".
  ...
  function highlightNonEmptyMessages(opts = {}) {
    const SHEET_NAME = opts.sheetName || 'חריגים-כללי';
